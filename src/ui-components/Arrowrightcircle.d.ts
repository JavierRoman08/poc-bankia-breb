...
export declare type ArrowrightcircleOverridesProps = {
    Arrowrightcircle?: PrimitiveOverrideProps<ViewProps>;
    "arrow-right-circle"?: PrimitiveOverrideProps<ViewProps>;
} & EscapeHatchProps;
export declare type ArrowrightcircleProps = React.PropsWithChildren<Partial<ViewProps> & {
