...
export declare type PhoneforwardedOverridesProps = {
    Phoneforwarded?: PrimitiveOverrideProps<ViewProps>;
    "phone-forwarded"?: PrimitiveOverrideProps<ViewProps>;
} & EscapeHatchProps;
export declare type PhoneforwardedProps = React.PropsWithChildren<Partial<ViewProps> & {
