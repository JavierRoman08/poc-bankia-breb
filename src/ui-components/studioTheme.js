...
export default createTheme({
  ...
  tokens: {
    ...
    colors: {
      ...
      brand: {
        primary: {
          10: { value: "hsl(161, 85%, 73%)" },
          20: { value: "hsl(161, 85%, 68%)" },
          40: { value: "hsl(161, 85%, 57%)" },
          60: { value: "hsl(161, 100%, 46%)" },
          80: { value: "hsl(161, 100%, 37%)" },
          90: { value: "hsl(161, 100%, 28%)" },
          100: { value: "hsl(161, 100%, 23%)" },
        },
        secondary: {
          10: { value: "hsl(194, 100%, 75%)" },
          20: { value: "hsl(194, 100%, 70%)" },
          40: { value: "hsl(194, 100%, 60%)" },
          60: { value: "hsl(194, 100%, 50%)" },
          80: { value: "hsl(194, 100%, 40%)" },
          90: { value: "hsl(194, 100%, 30%)" },
          100: { value: "hsl(194, 100%, 25%)" },
        },
      },
      font: {
